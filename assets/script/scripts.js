!(function (e) {
    ...
    e(window).scrollTop() > 100 &&
        e(".main-header").addClass("sticky fadeInDown"),
        e(window).on("scroll", function (t) {
            e(this).scrollTop() < 100
                ? e(".main-header").removeClass("sticky fadeInDown")
                : e(".main-header").addClass("sticky fadeInDown");
        }),
        e("[data-bg-img]").css("background", function () {
            return "url(" + e(this).data("bg-img") + ") center center";
        }),
        e(".parsley-validate, .parsley-validate form").parsley(),
        e(".comment-content > a").on("click", function (t) {
            t.preventDefault();
            var a = e(".comment-form");
            a.length &&
                (e("html, body").animate({ scrollTop: a.offset().top - 120 }, 500),
                    a.find("textarea").focus());
        }),
        (function () {
            e(window).width();
            e(".social-comment ul:last-child li:first-child").on(
                "click",
                function () {
    ...
    e(".gotoContent").click(function (e) {
    ...
    jQuery("img.svg").each(function () {
        ...
        0 != e(".single--pricing-plan") &&
        e(".single--pricing-plan").on("mouseenter", function () {
            e(this)
                .addClass("active")
                .parent()
                .siblings()
    ...
    if (
        (n.length &&
            n.each(function () {
                new Parallax(e(this)[0], { selector: "[data-depth]" });
            }),
            e(".single-faq .faq-question").on("click", function (t) {
                e(this).parents(".single-faq").children(".collapse").hasClass("show") &&
        ...
        i.length &&
            google.maps.event.addDomListener(window, "load", function () {
                ...
                new google.maps.Marker({ position: r, icon: "img/locator.png" }).setMap(
                    t
                );
            });
    }
    e("[data-countdown]").each(function () {
        ...
        t.countdown(t.data("countdown"), function (t) {
            e(this).html(
                ...
                t.strftime(
                    "<li><strong>%D</strong><span>D</span></li><li><strong>%H</strong><span>H</span></li><li><strong>%M</strong><span>M</span></li><li><strong>%S</strong><span>S</span></li>"
                ) +
                "</ul>"
            );
        });
        ...
        e("[data-countdown2]").each(function () {
            ...
            t.countdown(t.data("countdown2"), function (t) {
                e(this).html(
                    '<ul class="list-unstyled">' +
                    t.strftime(
                        "<li><span>Day</span><strong>%D</strong></li><li><span>Hours</span><strong>%H</strong></li><li><span>Month</span><strong>%M</strong></li><li><span>Secs</span><strong>%S</strong></li>"
                    ) +
                    "</ul>"
                );
            });
        ...
        e(".team-carousel").owlCarousel({
            ...
            responsive: {
                0: { items: 1 },
                320: { items: 3, center: !0 },
                767: { items: 5, center: !0 },
                1024: { items: 7, center: !0 },
            },
        }),
        ...
        e(".road-map-dot").on("mouseenter", function () {
            e(this)
                .parent()
                .children(".roadmap--hover-item")
                .css({ visibility: "visible", opacity: "1", "z-index": "10" })
                .parents(".owl-item")
                .siblings()
                .find(".roadmap--hover-item")
                .css({ visibility: "hidden", opacity: "0" });
        });
    var l = e('[data-popup="img"]');
    if (
        (l.length && l.magnificPopup({ type: "image" }),
            (l = e('[data-popup="video"]')).length &&
            l.magnificPopup({ type: "iframe" }),
            ...
            series: [
                {
                    ...
                    roseType: "radius",
                    label: { normal: { textStyle: { color: "#53e1ff" } } },
                    labelLine: {
                        normal: {
                            lineStyle: { color: "#53e1ff" },
                            smooth: 0.2,
                            length: 10,
                            length2: 20,
                        },
